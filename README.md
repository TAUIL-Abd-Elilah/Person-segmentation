In this notebook I implement an end-to-end pipeline that can be used as a template for handling image segmentation problems using python and segmentation_models_pytorch.
